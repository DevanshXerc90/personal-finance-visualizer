...
export default function Home() {
    ...
    return (
        <div className="container px-4 py-6">
            <h1 className="title text-center text-2xl sm:text-3xl font-bold mb-6">
            ...
            {/* Add Transaction */}
            <div className="card grid sm:grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                <div className="field">
                    <label>Amount (₹)</label>
            ...
            <div className="card grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                {categories.map((cat) => {
            ...
            <div className="space-y-4">
                {transactions.map((t) =>
                    editingId === t._id ? (
                        <div key={t._id} className="card grid sm:grid-cols-2 md:grid-cols-4 gap-2">
